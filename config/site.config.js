...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'nvlandi@outlook.com',
  ...
  protectedRoutes: [
    ...
    '/🧩 Pictures/Collections/mitaku',
    '/🧩 Pictures/Collections/welfare',
  ],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:zeongpaang@outlook.com',
